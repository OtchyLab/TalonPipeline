function [S,F,T,P] = SpecgramQuick(signal, Fs, freqRange, cLimits, startTime,xdata, nCourse, windowSize, NFFT)
...
[S,F,T,P] = helper_quickspectrogram(ud);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [S,F,T,P] = helper_quickspectrogram(ud)
