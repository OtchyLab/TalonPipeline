function [accScore, simScore] = SapSimilarity2(audio1, audio2, fs, dur, bCheckPlot)
...
%Continuity. This version differs from method described in that it assumes that
%INPUTS:
...
%Given a similarity matrix and an enclosing rectangle, this function returns a partial similarity score, an interval
